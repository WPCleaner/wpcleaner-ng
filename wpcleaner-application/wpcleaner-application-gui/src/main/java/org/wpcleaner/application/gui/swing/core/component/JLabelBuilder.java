...
public class JLabelBuilder {
  ...
  @SwingConstantsHorizontalAlignment private int horizontalAlignment;
  ...
  public JLabelBuilder withHorizontalAlignment(
      @SwingConstantsHorizontalAlignment final int horizontalAlignment) {
