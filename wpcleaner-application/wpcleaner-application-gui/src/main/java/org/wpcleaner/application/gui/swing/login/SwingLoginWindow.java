...
public final class SwingLoginWindow extends WPCleanerWindow {
  ...
  private void addButtons(
            ...
            .withAction(
                component ->
                    loginAction.execute(
                        ...
                        e -> swingCore.errorDialog().showErrorMessage(this, e)))
            .build();
    ...
    swingCore.layout().addRowSpanningAllColumns(panel, constraints, buttons);
